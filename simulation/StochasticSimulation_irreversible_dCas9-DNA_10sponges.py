...
Nspon_4dCas9 = 0.0 # sponge plasmids with 3 dCas9-sgRNA bound to them
Nspon_5dCas9 = 0.0 # sponge plasmids with 3 dCas9-sgRNA bound to them
Nspon_6dCas9 = 0.0 # sponge plasmids with 3 dCas9-sgRNA bound to them
Nspon_7dCas9 = 0.0 # sponge plasmids with 3 dCas9-sgRNA bound to them
Nspon_8dCas9 = 0.0 # sponge plasmids with 3 dCas9-sgRNA bound to them
Nspon_9dCas9 = 0.0 # sponge plasmids with 3 dCas9-sgRNA bound to them
Nspon_10dCas9 = 0.0 # sponge plasmids with 3 dCas9-sgRNA bound to them
...
Nspon_4dCas9_sim = np.array([])
Nspon_5dCas9_sim = np.array([])
Nspon_6dCas9_sim = np.array([])
Nspon_7dCas9_sim = np.array([])
Nspon_8dCas9_sim = np.array([])
Nspon_9dCas9_sim = np.array([])
Nspon_10dCas9_sim = np.array([])
...
Nspon_4dCas9_sim = np.append(Nspon_4dCas9_sim, Nspon_4dCas9)
Nspon_5dCas9_sim = np.append(Nspon_5dCas9_sim, Nspon_5dCas9)
Nspon_6dCas9_sim = np.append(Nspon_6dCas9_sim, Nspon_6dCas9)
Nspon_7dCas9_sim = np.append(Nspon_7dCas9_sim, Nspon_7dCas9)
Nspon_8dCas9_sim = np.append(Nspon_8dCas9_sim, Nspon_8dCas9)
Nspon_9dCas9_sim = np.append(Nspon_9dCas9_sim, Nspon_9dCas9)
Nspon_10dCas9_sim = np.append(Nspon_10dCas9_sim, Nspon_10dCas9)
...
def calculate_free_repressors():
    N = np.array([2 * (N_repressilator + Nrep_dCas9) + (N_sponge + Nspon_1dCas9 + Nspon_2dCas9 + Nspon_3dCas9 + Nspon_4dCas9 + Nspon_5dCas9 + Nspon_6dCas9 + Nspon_7dCas9 + Nspon_8dCas9 + Nspon_9dCas9 + Nspon_10dCas9),
                  2 * (N_repressilator + Nrep_dCas9) + N_sponge + Nspon_1dCas9 + Nspon_2dCas9 + Nspon_3dCas9 + Nspon_4dCas9 + Nspon_5dCas9 + Nspon_6dCas9 + Nspon_7dCas9 + Nspon_8dCas9 + Nspon_9dCas9 + Nspon_10dCas9])
...
propensity = np.array([lambda l, K, N_repressilator, Nrep_dCas9, n, p_free:
                       ...
                       lambda l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free:
                       l_sgRNA * (N_sponge + Nspon_1dCas9 + Nspon_2dCas9 + Nspon_3dCas9 + Nspon_4dCas9 + Nspon_5dCas9 + Nspon_6dCas9 + Nspon_7dCas9 + Nspon_8dCas9 + Nspon_9dCas9 + Nspon_10dCas9) * \
                           (K[0] ** n[0]) / (K[0] ** n[0] + p_free[0] ** n[0]),
                       ...
                       lambda l_dil, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9:
                       l_dil * (N_sponge + Nspon_1dCas9 + Nspon_2dCas9 + Nspon_3dCas9 + Nspon_4dCas9 + Nspon_5dCas9 + Nspon_6dCas9 + Nspon_7dCas9 + Nspon_8dCas9 + Nspon_9dCas9 + Nspon_10dCas9),
                       ...
                       lambda l_target, dCas9_sgRNA, Nspon_3dCas9:
                       l_target * dCas9_sgRNA * Nspon_3dCas9,
                       #p27
                       lambda l_target, dCas9_sgRNA, Nspon_4dCas9:
                       l_target * dCas9_sgRNA * Nspon_4dCas9, 
                       #p28
                       lambda l_target, dCas9_sgRNA,Nspon_5dCas9:
                       l_target * dCas9_sgRNA * Nspon_5dCas9,   
                       #p29
                       lambda l_target, dCas9_sgRNA,  Nspon_6dCas9:
                       l_target * dCas9_sgRNA * Nspon_6dCas9,
                       #p30
                       lambda l_target, dCas9_sgRNA, Nspon_7dCas9:
                       l_target * dCas9_sgRNA * Nspon_7dCas9, 
                       #p31
                       lambda l_target, dCas9_sgRNA, Nspon_8dCas9:
                       l_target * dCas9_sgRNA * Nspon_8dCas9,    
                       #p32
                       lambda l_target, dCas9_sgRNA, Nspon_9dCas9:
                       l_target * dCas9_sgRNA * Nspon_9dCas9, 
                       #p33
                       ])
...
total_propensity += propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)
...
total_propensity += propensity[13](l_dil, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9)
...
total_propensity += propensity[26](l_target, dCas9_sgRNA, Nspon_3dCas9)
total_propensity += propensity[27](l_target, dCas9_sgRNA, Nspon_4dCas9)
total_propensity += propensity[28](l_target, dCas9_sgRNA, Nspon_5dCas9)
total_propensity += propensity[29](l_target, dCas9_sgRNA, Nspon_6dCas9)
total_propensity += propensity[30](l_target, dCas9_sgRNA, Nspon_7dCas9)
total_propensity += propensity[31](l_target, dCas9_sgRNA, Nspon_8dCas9)
total_propensity += propensity[32](l_target, dCas9_sgRNA, Nspon_9dCas9)
...
while T <= time_window_of_simulation:
    ...
    # Calculate propensities
        ...
        r4 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
              + propensity[2](l, N_repressilator) + propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)) \
            / total_propensity
        ...
        r14 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               ...
               + propensity[13](l_dil, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9)) / total_propensity
        ...
        r15 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               ...
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) 
               + propensity[13](l_dil, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9)
        ...
        r17 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               ...
               + propensity[4](l_dCas9_sgRNA, sgRNA, dCas9) + propensity[5](l_dil, dCas9) + propensity[6](l_dil, l_tag, p) + propensity[7](l_dil, l_tag, p)
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) + propensity[13](l_dil, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9) 
        ...
        r26 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               + propensity[2](l, N_repressilator) + propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)
               + propensity[4](l_dCas9_sgRNA, sgRNA, dCas9) + propensity[5](l_dil, dCas9) + propensity[6](l_dil, l_tag, p) + propensity[7](l_dil, l_tag, p)
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) 
               ...
               + propensity[22](l_sgRNA, K, N_repressilator, Nrep_dCas9, n, p_free)
               + propensity[23](l_dCas9_sgRNA, sgRNA1, dCas9)
               + propensity[24](l_dil, dCas9_sgRNA1)
               + propensity[25](l_deg, sgRNA1)) / total_propensity  
 
        r27 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               + propensity[2](l, N_repressilator) + propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)
               + propensity[4](l_dCas9_sgRNA, sgRNA, dCas9) + propensity[5](l_dil, dCas9) + propensity[6](l_dil, l_tag, p) + propensity[7](l_dil, l_tag, p)
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) 
               ...
               + propensity[23](l_dCas9_sgRNA, sgRNA1, dCas9)
               + propensity[24](l_dil, dCas9_sgRNA1)
               + propensity[25](l_deg, sgRNA1)
               + propensity[26](l_target, dCas9_sgRNA, Nspon_3dCas9)) / total_propensity              
         
        r28 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               + propensity[2](l, N_repressilator) + propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)
               + propensity[4](l_dCas9_sgRNA, sgRNA, dCas9) + propensity[5](l_dil, dCas9) + propensity[6](l_dil, l_tag, p) + propensity[7](l_dil, l_tag, p)
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) 
               ...
               + propensity[24](l_dil, dCas9_sgRNA1)
               + propensity[25](l_deg, sgRNA1)
               + propensity[26](l_target, dCas9_sgRNA, Nspon_3dCas9)
               + propensity[27](l_target, dCas9_sgRNA, Nspon_4dCas9)) / total_propensity            

        r29 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               + propensity[2](l, N_repressilator) + propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)
               + propensity[4](l_dCas9_sgRNA, sgRNA, dCas9) + propensity[5](l_dil, dCas9) + propensity[6](l_dil, l_tag, p) + propensity[7](l_dil, l_tag, p)
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) 
               ...
               + propensity[25](l_deg, sgRNA1)
               + propensity[26](l_target, dCas9_sgRNA, Nspon_3dCas9)
               + propensity[27](l_target, dCas9_sgRNA, Nspon_4dCas9)
               + propensity[28](l_target, dCas9_sgRNA, Nspon_5dCas9)) / total_propensity    

        r30 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               + propensity[2](l, N_repressilator) + propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)
               + propensity[4](l_dCas9_sgRNA, sgRNA, dCas9) + propensity[5](l_dil, dCas9) + propensity[6](l_dil, l_tag, p) + propensity[7](l_dil, l_tag, p)
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) 
               ...
               + propensity[26](l_target, dCas9_sgRNA, Nspon_3dCas9)
               + propensity[27](l_target, dCas9_sgRNA, Nspon_4dCas9)
               + propensity[28](l_target, dCas9_sgRNA, Nspon_5dCas9)
               + propensity[29](l_target, dCas9_sgRNA, Nspon_6dCas9)) / total_propensity

        r31 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               + propensity[2](l, N_repressilator) + propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)
               + propensity[4](l_dCas9_sgRNA, sgRNA, dCas9) + propensity[5](l_dil, dCas9) + propensity[6](l_dil, l_tag, p) + propensity[7](l_dil, l_tag, p)
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) 
               ...
               + propensity[27](l_target, dCas9_sgRNA, Nspon_4dCas9)
               + propensity[28](l_target, dCas9_sgRNA, Nspon_5dCas9)
               + propensity[29](l_target, dCas9_sgRNA, Nspon_6dCas9)
               + propensity[30](l_target, dCas9_sgRNA, Nspon_7dCas9)) / total_propensity

        r32 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
               + propensity[2](l, N_repressilator) + propensity[3](l_sgRNA, K, N_sponge, Nspon_1dCas9, Nspon_2dCas9, Nspon_3dCas9, Nspon_4dCas9, Nspon_5dCas9, Nspon_6dCas9, Nspon_7dCas9, Nspon_8dCas9, Nspon_9dCas9, Nspon_10dCas9, n, p_free)
               + propensity[4](l_dCas9_sgRNA, sgRNA, dCas9) + propensity[5](l_dil, dCas9) + propensity[6](l_dil, l_tag, p) + propensity[7](l_dil, l_tag, p)
               + propensity[8](l_dil, dCas9_sgRNA) + propensity[9](l_deg, sgRNA) + propensity[10](l_plasmid, N_repressilator_mean)
               + propensity[11](l_plasmid, N_sponge_mean) + propensity[12](l_dil, N_repressilator, Nrep_dCas9) 
               ...
               + propensity[28](l_target, dCas9_sgRNA, Nspon_5dCas9)
               + propensity[29](l_target, dCas9_sgRNA, Nspon_6dCas9)
               + propensity[30](l_target, dCas9_sgRNA, Nspon_7dCas9)
               + propensity[31](l_target, dCas9_sgRNA, Nspon_8dCas9)) / total_propensity
...
###############################################################################
  ...
  # distributed with mean <b>=1/p
        ...
        # print('reaction 4')
            ...
            SponSum = N_sponge + Nspon_1dCas9 + Nspon_2dCas9 + Nspon_3dCas9 + Nspon_4dCas9 + Nspon_5dCas9 + Nspon_6dCas9 + Nspon_7dCas9 + Nspon_8dCas9 + Nspon_9dCas9 + Nspon_10dCas9
            spon = [N_sponge/SponSum, Nspon_1dCas9/SponSum, Nspon_2dCas9/SponSum, Nspon_3dCas9/SponSum, Nspon_4dCas9/SponSum, Nspon_5dCas9/SponSum, Nspon_6dCas9/SponSum, Nspon_7dCas9/SponSum, Nspon_8dCas9/SponSum, Nspon_9dCas9/SponSum, Nspon_10dCas9/SponSum]
            rn0 = random.random()
            ...
            elif spon[0]+spon[1]+spon[2] < rn0 <= spon[0]+spon[1]+spon[2]+spon[3]:
                Nspon_3dCas9 -= 1                

            elif spon[0]+spon[1]+spon[2]+spon[3] < rn0 <= spon[0]+spon[1]+spon[2]+spon[3]+spon[4]:
                Nspon_4dCas9 -= 1    
                
            elif spon[0]+spon[1]+spon[2]+spon[3]+spon[4] < rn0 <= spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5]:
                Nspon_5dCas9 -= 1  

            elif spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5] < rn0 <= spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5]+spon[6]:
                Nspon_6dCas9 -= 1 

            elif spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5]+spon[6] < rn0 <= spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5]+spon[6]+spon[7]:
                Nspon_7dCas9 -= 1  

            elif spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5]+spon[6]+spon[7] < rn0 <= spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5]+spon[6]+spon[7]+spon[8]:
                Nspon_8dCas9 -= 1  
            
            elif spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5]+spon[6]+spon[7]+spon[8] < rn0 <= spon[0]+spon[1]+spon[2]+spon[3]+spon[4]+spon[5]+spon[6]+spon[7]+spon[8]+spon[9]:
                Nspon_9dCas9 -= 1      
        ...
        # update total time        
           ...
           if sgRNA1 >= 1:
            ...
            if dCas9_sgRNA >= 1 and Nspon_3dCas9 >= 1:
                Nspon_4dCas9 += 1
                Nspon_3dCas9 -= 1
                dCas9_sgRNA -= 1
                
        elif r27 < rho <= r28:
            if dCas9_sgRNA >= 1 and Nspon_4dCas9 >= 1:
                Nspon_5dCas9 += 1
                Nspon_4dCas9 -= 1
                dCas9_sgRNA -= 1

        elif r28 < rho <= r29:
            if dCas9_sgRNA >= 1 and Nspon_5dCas9 >= 1:
                Nspon_6dCas9 += 1
                Nspon_5dCas9 -= 1
                dCas9_sgRNA -= 1                   

        elif r29 < rho <= r30:
            if dCas9_sgRNA >= 1 and Nspon_6dCas9 >= 1:
                Nspon_7dCas9 += 1
                Nspon_6dCas9 -= 1
                dCas9_sgRNA -= 1  

        elif r30 < rho <= r31:
            if dCas9_sgRNA >= 1 and Nspon_7dCas9 >= 1:
                Nspon_8dCas9 += 1
                Nspon_7dCas9 -= 1
                dCas9_sgRNA -= 1  

        elif r31 < rho <= r32:
            if dCas9_sgRNA >= 1 and Nspon_8dCas9 >= 1:
                Nspon_9dCas9 += 1
                Nspon_8dCas9 -= 1
                dCas9_sgRNA -= 1  

        elif r32 < rho <= 1:
            if dCas9_sgRNA >= 1 and Nspon_9dCas9 >= 1:
                Nspon_10dCas9 += 1
                Nspon_9dCas9 -= 1
                dCas9_sgRNA -= 1  
        ...
        Nspon_total = N_sponge + Nspon_1dCas9 + Nspon_2dCas9 + Nspon_3dCas9 + Nspon_4dCas9 + Nspon_5dCas9 + Nspon_6dCas9 + Nspon_7dCas9 + Nspon_8dCas9 + Nspon_9dCas9 + Nspon_10dCas9
...
df = pd.DataFrame({'Time': t_interp,
                    ...
                    'dCas9': interp_vector(dCas9_sim[cond], t_sim[cond], t_interp),
...
filename = 'sim_irr_10sponges.csv'
