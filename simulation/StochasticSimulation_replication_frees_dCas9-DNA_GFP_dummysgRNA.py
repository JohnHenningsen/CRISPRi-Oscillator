...
# Here dCas9-sgRNA bind irreversibly to the target DNA. However, plasmid replication frees the plasmid from bound dCas9-sgRNA.
...
plt.figure(3)
plt.plot(t_sim / 3600, N_repressilator_sim, label='Rep', linewidth=5)
plt.plot(t_sim / 3600, Nrep_dCas9_sim, label='Rep_dCas9', linewidth=5)
maxim = max([np.amax(N_repressilator_sim), np.amax(Nrep_dCas9_sim)])
plt.axis([0, T / 3600, 0, maxim + 0.1 * maxim])
plt.tick_params(labelsize=20)
plt.xlabel('t[hours]', fontsize=20)
plt.ylabel('Number of Plasmids', fontsize=20)
plt.legend(fontsize=5)

plt.figure(4)
plt.plot(t_sim / 3600, N_sponge_sim, label='Sponge', linewidth=5)
plt.plot(t_sim / 3600, Nspon_1dCas9_sim, label='Sponge-1dCas9', linewidth=5)
plt.plot(t_sim / 3600, Nspon_2dCas9_sim, label='Sponge-2dCas9', linewidth=5)
plt.plot(t_sim / 3600, Nspon_3dCas9_sim, label='Sponge-3dCas9', linewidth=5)
plt.plot(t_sim / 3600, Nspon_total_sim, label='Sponge-total', linewidth=5)
maxim = max([np.amax(N_sponge_sim), np.amax(Nspon_1dCas9_sim), np.amax(Nspon_2dCas9_sim), np.amax(Nspon_3dCas9_sim), np.amax(Nspon_total_sim)])
plt.axis([0, T / 3600, 0, maxim + 0.1 * maxim])
plt.tick_params(labelsize=20)
plt.xlabel('t[hours]', fontsize=20)
plt.ylabel('Number of Plasmids', fontsize=20)
