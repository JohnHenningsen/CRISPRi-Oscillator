...
dCas9_tot = dCas9 + dCas9_sgRNA + Nrep_dCas9 + Nspon_1dCas9 + 2*Nspon_2dCas9 + 3*Nspon_3dCas9 + dCas9_sgRNA1
...
dCas9_tot_sim = np.append(dCas9_tot_sim,dCas9_tot)
...
propensity = np.array([lambda l, K, N_repressilator, Nrep_dCas9, n, p_free:
                       ...
                       lambda l_tag, dCas9_tot:
                       l_tag * dCas9_tot
                       # p27 dCas9 protein tag degradation
                       ])
...
total_propensity += propensity[26](l_tag, dCas9_tot)
...
###############################################################################
  ...
  # distributed with mean <b>=1/p
        ...
        # update total time        
           ...
           if dCas9_tot >= 1:
               dcas9conc= [dCas9/dCas9_tot, dCas9_sgRNA/dCas9_tot, Nrep_dCas9/dCas9_tot, Nspon_1dCas9/dCas9_tot, 2*Nspon_2dCas9/dCas9_tot, 3*Nspon_3dCas9/dCas9_tot, dCas9_sgRNA1/dCas9_tot]
               rn0 = random.random()
