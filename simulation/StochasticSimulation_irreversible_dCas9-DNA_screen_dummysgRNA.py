...
##LOOP START
for i_screen, x in enumerate(x_screen):
    ...
    propensity = np.array([lambda l, K, N_repressilator, Nrep_dCas9, n, p_free:
                           ...
                           l_dil * GFPmat,
                           # p22 GFPmat dilution
                           lambda l_sgRNA1, K, N_repressilator, Nrep_dCas9, n, p_free, x:
                           l_sgRNA1 * x * (N_repressilator + Nrep_dCas9) * \
                               (K[0] ** n[0]) / (K[0] ** n[0] + p_free[0] ** n[0]),
    ...
    total_propensity += propensity[22](l_sgRNA1, K, N_repressilator, Nrep_dCas9, n, p_free, x)
    ...
    while T <= time_window_of_simulation:
        ...
        # Calculate propensities
            ...
            r23 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
                   ...
                   + propensity[22](l_sgRNA1, K, N_repressilator, Nrep_dCas9, n, p_free, x)) / total_propensity
            ...
            r24 = (propensity[0](l, K, N_repressilator, Nrep_dCas9, n, p_free) + propensity[1](l, K, N_repressilator, Nrep_dCas9, n, p_free)
                   ...
                   + propensity[19](l_dil, GFP) + propensity[20](l_mat, GFP)
                   + propensity[21](l_dil, GFPmat)
                   + propensity[22](l_sgRNA1, K, N_repressilator, Nrep_dCas9, n, p_free, x)
    ...
    def interp_vector(vector_sim, t_sim, t_interp):
        interp_func = interp1d(t_sim, vector_sim, fill_value='extrapolate', kind='linear')
    ...
    df = pd.DataFrame({'Time': t_interp,
                          ...
                          'dCas9-sgRNA1': interp_vector(dCas9_sgRNA1_sim[cond], t_sim[cond], t_interp),
                          'sgRNA1': interp_vector(sgRNA1_sim[cond], t_sim[cond], t_interp)})
    
    filename = f'sgRNA1_dna{i_screen}.csv'
